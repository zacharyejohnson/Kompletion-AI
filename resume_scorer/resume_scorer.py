...
def score_resume(resume1_path, resume2_path, job_description):
    ...
    prompt = f"You are a job matcher. I will give you a job description and 2 resumes and you will give them a score 1-100 and explain why and select the better candidate by name. The job description is: {job_description}. The resume1 is: {resume_text1} The resume2 is: {resume_text2}"
